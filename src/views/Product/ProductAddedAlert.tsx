...
import {
  ...
  AlertDescription,
  AlertTitle,
} from "../../../../enterprise-commerce/apps/web/components/Alert/Alert";
import { Button } from "../../../../enterprise-commerce/apps/web/components/Button/Button";
import Image from "next/image";
import { useRouter } from "next/navigation";
import { useAddProductStore } from "../../../../enterprise-commerce/apps/web/stores/addProductStore";
import { useCartStore } from "../../../../enterprise-commerce/apps/web/stores/cartStore";
import { cn } from "../../../../enterprise-commerce/apps/web/utils/cn";
import {
  type CurrencyType,
  mapCurrencyToSign,
} from "../../../../enterprise-commerce/apps/web/utils/mapCurrencyToSign";
          ...
          <div className="flex gap-6">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs">
                {mapCurrencyToSign(
                  combination!.price!.currencyCode as CurrencyType,
                )}
