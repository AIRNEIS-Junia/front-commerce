import type { PlatformCartItem } from "../../../../enterprise-commerce/packages/core/platform/types";
import Link from "next/link";
import { cn } from "../../../../enterprise-commerce/apps/web/utils/cn";
import type { Combination } from "../../../../enterprise-commerce/apps/web/utils/productOptionsUtils";
...
export function Variant({
  ...
  const availableForSale =
    singleCombination?.availableForSale && quantityAvailable > 0;
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        {
          "stroke-black opacity-80 hover:bg-transparent hover:text-black":
            isOutOfStock,
        },
      )}
    >
