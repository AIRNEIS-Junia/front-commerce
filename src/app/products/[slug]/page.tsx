...
import { BackButton } from "src/views/Product/BackButton";
import { DetailsSection } from "src/views/Product/DetailsSection";
import { FavoriteMarker } from "src/views/Product/FavoriteMarker";
import { GallerySection } from "src/views/Product/GallerySection";
import { InfoSection } from "src/views/Product/InfoSection";
import { PageSkeleton } from "src/views/Product/PageSkeleton";
import { SimilarProductsSection } from "src/views/Product/SimilarProductsSection";
import { SimilarProductsSectionSkeleton } from "src/views/Product/SimilarProductsSectionSkeleton";
import { VariantsSection } from "src/views/Product/VariantsSection";
import { slugToName } from "src/utils/slug-name";
